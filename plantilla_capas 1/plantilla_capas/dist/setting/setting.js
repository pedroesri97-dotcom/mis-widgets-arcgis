...
/***/ "./your-extensions/widgets/plantilla_capas/src/setting/translations/default.ts":
...
var defaultI18nMessages = __webpack_require__("./your-extensions/widgets/plantilla_capas/src/setting/translations/default.ts");
...
class Setting extends jimu_core.React.PureComponent {
  ...
  render() {
    ...
    return (_emotion_jsx.jsx)("div", {
      css: style,
      className: "widget-setting-plantilla-capas",
            ...
            children: [
                ...
                children: (_emotion_jsx.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (_emotion_jsx.jsx)(jimu_ui.TextInput, {
                      value: ((_a = this.props.config) === null || _a === void 0 ? void 0 : _a.title) || 'Capas por',
              ...
              (_emotion_jsx.jsx)(setting_components.SettingRow, {
                children: (_emotion_jsx.jsxs)("div", {
                  className: "setting-row-item",
                  children: [
                    (_emotion_jsx.jsx)("label", { children: defaultI18nMessages.default.titleHighlightLabel }),
                    (_emotion_jsx.jsx)(jimu_ui.TextInput, {
                      value: ((_b = this.props.config) === null || _b === void 0 ? void 0 : _b.titleHighlight) || 'componente',
